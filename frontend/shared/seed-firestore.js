...
// Запустите этот скрипт с помощью Node.js: node seed-firestore.js <user_id>
...
async function seedFirestore(userId) {
  try {
...
if (!userId) {
  ...
  console.error("Usage: node seed-firestore.js <user_id>");
  process.exit(1);
}
